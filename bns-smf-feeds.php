...
class BNS_SMF_Feeds_Widget extends WP_Widget {
    ...
    function BNS_SMF_Feeds_Widget() {
        ...
        /** Add Widget */
        add_action( 'widgets_init', array( $this, 'load_bns_smf_feeds_widget' ) );

        /** Add Shortcode */
        add_shortcode( 'bns_smf_feeds', array( $this, 'BNS_SMF_Feeds_Shortcode' ) );
    ...
    function widget( $args, $instance ) {
        ...
        $this->bns_wp_widget_rss_output( $smf_feed_url, array(
